...
cfg.use_pcen = False
cfg.n_mels = 64  # [64, 128, 224, 256]
cfg.fmin = 50  # [20, 50]
cfg.fmax = 14000  # [14000, 16000]
cfg.n_fft = 1024  # [1024, 2048]
cfg.hop_length = 320  # [320, 512]
...
cfg.pretrained_path = '../models/exp087_eca_nfnet_l0/fold_0_model.bin'
